  ...
  return (
    <>
      <Head>
        ...
        <meta property="og:site_name" content="Profit Saloon" />
        ...
        <span itemProp="author" itemType="http://schema.org/Person">
          <link
            itemProp="url"
            href={`https://profitsaloon.vercel.app/videos/${videoData?.users?.username}`}
          />
          <link itemProp="name" content={videoData?.users?.name} />
        </span>
        <meta property="twitter:domain" content="profitsaloon.vercel.app" />
