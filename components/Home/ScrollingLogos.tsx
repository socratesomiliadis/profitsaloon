    ...
    <section className="relative bg-black w-screen -mt-[5%] flex flex-col items-center">
      <div className="flex flex-col items-center gap-2 z-10">
        ...
        <h3 className="text-center text-5xl font-medium text-[#ededed]">
          Create a consistent <br />
          and modern workflow.
        </h3>
      </div>
      <div className="mt-20 flex flex-row items-center gap-24 opacity-60">
        <Image
      ...
      <div className="glowing-cirlce relative select-none w-2/3 h-[800px] overflow-hidden">
        <svg
