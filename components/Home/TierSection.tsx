      ...
      {!isTiersPage && (
        <div className="relative w-full h-[1800px]">
          <div className="labels-section z-10">
            <div className="tier-label flex flex-row items-start gap-4 absolute left-[35%] top-[27.8%]">
              ...
              <div className="flex flex-col gap-2">
                ...
                <p className="text-[#818181] text-[12px]">
                  ...
                  <br />
                  to connect with like-minded individuals, share ideas, and{" "}
                  <br />
            ...
            <div className="tier-label flex flex-row items-start gap-4 absolute left-[61.5%] top-[40.8%]">
              ...
              <div className="flex flex-col gap-2">
                ...
                <p className="text-[#818181] text-[12px]">
                  ...
                  <br />
                  filled with like-minded individuals and opportunities for{" "}
                  <br />
            ...
            <div className="tier-label flex flex-row items-start gap-4 absolute left-[40%] top-[61.6%]">
              ...
              <div className="flex flex-col gap-2">
                ...
                <p className="text-[#818181] text-[12px]">
                  Our primary focus is on assisting people in establishing{" "}
                  <br />
          ...
          <Image
            ...
            width={2000}
            height={2000}
            className="absolute w-[70%] top-1/2 -translate-y-1/2 left-1/2 -translate-x-1/2 opacity-30 z-0"
            alt=""
          />
        </div>
      )}
