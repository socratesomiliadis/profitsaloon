    ...
    <section className="featured-courses relative w-screen min-h-screen bg-[#000]">
      ...
      <div className="mt-32 w-full flex flex-col items-center z-[4] relative">
        ...
        <div className="relative flex w-full h-[50vh] items-center justify-center isolate z-0">
          ...
          <div className="absolute inset-auto right-1/2 h-full w-1/2 bg-gradient-conic from-[#48FF86] via-[#000] to-transparent text-white [--conic-position:from_70deg_at_center_top]"></div>
          <div className="absolute inset-auto left-1/2 h-full w-1/2 bg-gradient-conic from-transparent via-[#000] to-[#48FF86] text-white [--conic-position:from_290deg_at_center_top]"></div>
          <div className="absolute top-1/2 h-[20vh] w-full translate-y-[20%] scale-x-150 bg-[#000] blur-2xl"></div>
          <div className="absolute top-1/2 z-50 h-[20vh] w-full bg-[#000] opacity-[0.01] backdrop-blur-md"></div>
