...
export default function Footer() {
  return (
    <footer className="w-full min-h-[80vh] py-8 lg:py-32 bg-[#060606] px-6 lg:px-16 xl:px-[6vw] 3xl:px-[8vw] flex flex-col gap-16 md:gap-64 justify-between">
      <div className="flex flex-row w-full items-start justify-between z-20">
        <div className="flex flex-col gap-16 w-full 2xl:w-fit">
          <div className="ml-6 flex flex-row items-center justify-start w-full 2xl:w-fit gap-8">
            <div className="profit-svg h-[80px] ">
              <svg
                width="100%"
                viewBox="0 0 272 50"
                fill="none"
